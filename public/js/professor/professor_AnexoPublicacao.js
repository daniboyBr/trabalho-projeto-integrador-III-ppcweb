...
$(document).ready(function () {
    ...
    $('#adicionarComprovante').on('click',function () {
        ...
        if(comprovante.trim().length != 0 && data.trim().length != 0 && local.trim().length != 0 && anexo.length != 0){
            ...
            comprovante = "<input type='text' class='form-control form-control-sm' name='comprovantePublicacao["+counter3+"][comprovante]' readonly='readonly'value='"+comprovante+"'/>";
            data = "<input type='text' class='form-control form-control-sm' name='comprovantePublicacao["+counter3+"][data]' readonly='readonly'value='"+data+"' />";
            local = "<input type='text' class='form-control form-control-sm' name='comprovantePublicacao["+counter3+"][local]' readonly='readonly' value='"+local+"' />";
            ...
            clone.attr('name','comprovantePublicacao['+counter3+'][anexo]');
